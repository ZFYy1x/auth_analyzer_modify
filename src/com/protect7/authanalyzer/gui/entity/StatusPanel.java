...
public class StatusPanel extends JPanel{
	...
	private final JLabel headerLabel = new JLabel("<html><strong>要替换的请求头</strong></html>");
	private final JLabel headerToReplaceValue = new JLabel("");
	private final JLabel headerRemoveLabel = new JLabel("<html><strong>要移除的请求头</strong></html>");
	...
	public void init(Session session) {
		...
		if(session.getHeadersToReplace().equals("")) {
			...
			headerLabel.setText("<html><p><strong>要替换的请求头</strong></html>");
			headerLabel.putClientProperty("html.disable", null);
